 ...
 */
final class Version20190109202927 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE wallpaper (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, subreddit_id INTEGER DEFAULT NULL, hash VARCHAR(64) NOT NULL COLLATE BINARY, rating INTEGER NOT NULL DEFAULT 0, CONSTRAINT FK_D592642C31DBE174 FOREIGN KEY (subreddit_id) REFERENCES sub_reddit (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__wallpaper AS SELECT id, subreddit_id, hash FROM wallpaper');
        $this->addSql('DROP TABLE wallpaper');
        $this->addSql('CREATE TABLE wallpaper (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, subreddit_id INTEGER DEFAULT NULL, hash VARCHAR(64) NOT NULL)');
        $this->addSql('INSERT INTO wallpaper (id, subreddit_id, hash) SELECT id, subreddit_id, hash FROM __temp__wallpaper');
        $this->addSql('DROP TABLE __temp__wallpaper');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_D592642CD1B862B8 ON wallpaper (hash)');
        $this->addSql('CREATE INDEX IDX_D592642C31DBE174 ON wallpaper (subreddit_id)');
